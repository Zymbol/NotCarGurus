...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>1992 Ford Aerostar</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '4USBU33576L116903'"); ?>
<form method="POST">
