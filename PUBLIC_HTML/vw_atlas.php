...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2018 Volkswagon Atlas</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '5NPDREEE6FH449495'"); ?>
<form method="POST">
