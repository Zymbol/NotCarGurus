...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2018 Chrysler 300</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '2T1BU4EEXBC031824'"); ?>
<form method="POST">
