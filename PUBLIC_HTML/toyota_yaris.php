...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2007 Toyota Yaris</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '07PDH4AE6FH449495'"); ?>
<form method="POST">
