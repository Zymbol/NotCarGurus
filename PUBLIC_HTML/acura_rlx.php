...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2018 Acura RLX</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '5NPDH4BR6FH329495'"); ?>
<form method="POST">
