...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2020 GMC Sierra AT4</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = 'WDDLJ7DB5CA308462'"); ?>
<form method="POST">
