...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>1997 Mitsubishi Diamante</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '1GTN1TEH1EZ047219'"); ?>
<form method="POST">
