...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2014 Cadillac CTS</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '4T1BK3DB0BU135535'"); ?>
<form method="POST">
