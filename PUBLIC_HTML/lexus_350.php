...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2020 Lexus RX-350</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '19UUA56642A233157'"); ?>
<form method="POST">
