...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2011 Lotus Evora</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '1G6KE57Y33U544933'"); ?>
<form method="POST">
