...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2020 BMW i8</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '5NPDH4AE6FH549495'"); ?>
<form method="POST">
