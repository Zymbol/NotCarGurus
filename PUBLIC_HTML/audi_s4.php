...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2021 Audi S4</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '19UUA56731A099829'"); ?>
<form method="POST">
