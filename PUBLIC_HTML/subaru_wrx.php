...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2015 Subaru WRX</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '5NPD96AE6FH449419'"); ?>
<form method="POST">
