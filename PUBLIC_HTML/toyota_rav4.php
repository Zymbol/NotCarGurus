...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2019 Toyota Rav4</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = 'WAUVFAFH9BN864684'"); ?>
<form method="POST">
