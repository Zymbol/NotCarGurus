...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>1990 Plymouth Laser</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '1GYEK63N85R655109'"); ?>
<form method="POST">
