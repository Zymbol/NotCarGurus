...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2019 Ford Raptor</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '4T1BK1EB6FU752527'"); ?>
<form method="POST">
