...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>2019 Land Rover Range Rover</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = 'WA1AV94L87D107258'"); ?>
<form method="POST">
