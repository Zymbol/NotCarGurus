...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>1999 Honda Civic</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = 'YV1952AS5E1470301'"); ?>
<form method="POST">
