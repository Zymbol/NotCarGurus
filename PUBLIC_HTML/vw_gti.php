...
include "header.php";?>
<div >
<div class="container-md" style="text-align: center; margin-bottom: 2rem;"><hr><h3>Volkswagon GTI</h3><hr></div>
<?php $result = $conn->query("SELECT * FROM Vehicle WHERE VIN = '1GD312CG5EF086369'"); ?>
<form method="POST">
